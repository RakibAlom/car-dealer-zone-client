      ...
      <div className="modal">
        <div className="modal-box">
          ...
          <div className="modal-action">
            ...
            <label onClick={() => successAction(modalData)} htmlFor={htmlFor} className="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transhtmlFor=m bg-blue-600 rounded-md sm:w-auto sm:mt-0 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 cursor-pointer">
              {successButtonName}
            </label>
          </div>
        </div>
