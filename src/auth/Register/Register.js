          ...
          <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
              ...
              <form className="mt-6" onSubmit={handleSubmit(handleRegister)}>
                <div>
                  <label for="userType" className="block text-sm text-gray-800 dark:text-gray-200">Account Type</label>
                ...
                <div className="mt-4">
                  <label for="avatar" className="block text-sm text-gray-800 dark:text-gray-200">Avatar</label>
